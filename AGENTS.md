...
- **nginx.conf**: Web server config (gzip, 30-day static caching, security headers, PHP routing, WP backend blocking)
- **static-site/sitemap.xml**: XML sitemap for search engines
- **static-site/robots.txt**: Crawl rules with sitemap reference
